...
export const App: FC = () => {
  ...
  const currentData = selectedIndex !== null ? ALL_QUIZZES[selectedIndex] : null;
      ...
      <div className="max-w-3xl mx-auto">
        <header className="mb-6">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            Sélectionnez un quiz pour commencer. Votre dernier quiz ouvert est enregistré.
          </p>
        </header>
        ...
        {selectedIndex === null ? (
          <div className="grid gap-4">
            {ALL_QUIZZES.map((q, i) => (
              <div
                key={i}
                className="bg-white p-4 rounded shadow flex items-center justify-between dark:bg-slate-800"
              >
                <div>
